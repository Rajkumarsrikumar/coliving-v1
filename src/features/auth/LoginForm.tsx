  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          {onForgotPassword && (
            <button
              ...
              className="text-xs font-medium text-coral-700 hover:text-coral-800 hover:underline"
            >
              Forgot password?
            </button>
          )}
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <button type="button" onClick={onSwitchToSignUp} className="font-medium text-coral-700 hover:text-coral-800 hover:underline">
          Sign up
        </button>
      </p>
    </form>
